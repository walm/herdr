...
pub(crate) use self::{
    ...
    sidebar::{
        agent_panel_body_rect, agent_panel_entries, agent_panel_scope_toggle_rect,
...
pub(crate) use self::{
    ...
    tabs::{compute_tab_bar_view, workspace_tab_label_width},
    ...
    let tab_bar_view = app
        ...
        .map(|ws| {
            compute_tab_bar_view(
                ...
                app.mouse_capture,
                app.tab_number_prefix,
                workspace_tab_label_width(app),
            )
        })
        .unwrap_or_default();
