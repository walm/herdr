...
use super::super::api_helpers::{
    detect_state_from_api, encode_api_keys, normalize_marker, normalize_metadata_source,
...
impl App {
    ...
    pub(super) fn close_pane(
        ...
        {
            // Same shape as the worktree-group guard below: the error is what a
            // script sees, and an interactive client raises its confirm dialog
            // from the `confirmation_required` code before retrying with force.
