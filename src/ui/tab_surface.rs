...
mod tests {
    ...
    async fn desktop_full_app_semantic_frame_is_characterized() {
        ...
        // Differs from upstream's digest because our agent-panel scope toggle
        // adds an "all"/"current" label to the agents header row.
        assert_eq!(
            frame_digest(&frame),
            "bc46d6a297c827e4616d88a6a6ef673bec48f59bd8124990c9f1c4ab5b4561e8"
        );
    }
