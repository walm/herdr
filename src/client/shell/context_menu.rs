        ...
        match &self.target {
            ...
            ClientContextMenuTarget::Pane {
                ...
                items.extend([
                    ...
                    item(
                        if *pinned { "Unpin pane" } else { "Pin pane" },
                        Action::TogglePin,
                    ),
...
impl ClientShellState {
    ...
    fn activate_workspace_context_action(
        ...
        match action {
            ...
            ClientContextMenuAction::Close => {
                if self.config.confirm_close || self.workspace_has_pinned_pane(&workspace_id) {
    ...
    fn activate_tab_context_action(
        ...
        match action {
            ...
            ClientContextMenuAction::Close => {
                self.push_endpoint_method(
                    Method::TabClose(crate::api::schema::TabCloseParams {
                        tab_id,
                        force: false,
                    }),
                    outcome,
    ...
    fn activate_pane_context_action(
        ...
        use crate::api::schema::{
            ...
            PaneSetPinnedParams, PaneSplitParams, PaneSwapParams, PaneTarget, PaneZoomMode,
        ...
        match action {
            ...
            ClientContextMenuAction::TogglePin => self.push_endpoint_method(
